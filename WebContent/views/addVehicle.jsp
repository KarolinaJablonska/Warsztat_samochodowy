...
<body>
	<div class="panel panel-primary">
		...
		<h4>Wprowadź dane nowego samochodu </h4><br/>

		<form class="form-horizontal" action="../../../Warsztat_samochodowy/AddVehicle" method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="inputMark" name="mark" required>
					<span id="helpBlock" class="help-block">[pole wymagane]</span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="number" class="form-control" id="inputProductionYear" name = "productionYear" placeholder = "2000" 
